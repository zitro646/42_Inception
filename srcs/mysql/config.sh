...
#echo 'CREATE USER IF NOT EXISTS '"'$MYSQL_ADMIN_USER'"' IDENTIFIED BY '"'$MYSQL_USER_PASSWORD'" ';' >> input_data/test.sql
echo 'GRANT ALL PRIVILEGES ON *.* TO '"'$MYSQL_ADMIN_USER'"'@'"'%'"' IDENTIFIED BY '"'$MYSQL_USER_PASSWORD'"' WITH GRANT OPTION;' >> input_data/test.sql
...
#echo 'FLUSH PRIVILEGES;' >> input_data/test.sql
